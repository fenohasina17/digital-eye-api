...
@include('parent.partials._page-loader')
@include('parent.layouts.layout')
@include('parent.partials._extras.offcanvas.quick-user')
@include('parent.partials._extras.scrolltop')
@include('parent.partials._extras.toolbar')
@include('parent.partials._extras.offcanvas.demo-panel')
...
@include('parent.partials._scripts')
</body>
