        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            ...
            <div class="card-toolbar">
              ...
              <a href="{{ route('parent.dashboard') }}" class="btn btn-light-primary
              font-weight-bolder mr-2">
                <i class="ki ki-long-arrow-back icon-sm"></i>Back</a>

              <div class="btn-group">
                <a href=""  onclick="event.preventDefault(); document.getElementById('parent_update_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            {{ Form::model($user, [ 'method' => 'POST','route' => ['parent-update', $user->id],'class'=>'form' ,"id"=>"parent_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
