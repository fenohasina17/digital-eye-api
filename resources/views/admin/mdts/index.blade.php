...
@section('content')
  ...
  <div class="card card-custom ">
    ...
    <div class="card-body">
      ...
      <div class="">
	      <form action="{{route('admin.delete-selected-mdts')}}" method="post" id="client_form">
...
@section('scripts')
  ...
  <script>
      ...
      function viewInfo(id) {
          ...
          $.post("{{ route('admin.getMdt') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
      ...
      function del(id){
          ...
          icon: "warning",
              ...
              if (result.value) {
                  ...
                  window.location.href = APP_URL+"/admin/mdt/delete/"+id;
              }
          });
      }
