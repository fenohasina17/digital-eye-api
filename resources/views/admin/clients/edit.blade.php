                ...
                <div class="col-xl-8">
                  <div class="my-5">
                    <div class="form-group row {{ $errors->has('name') ? 'has-error' : '' }}">
                      ...
                      <div class="col-9">
                        {{ Form::text('name', null, ['class' => 'form-control form-control-solid','id'=>'name','placeholder'=>'Enter Name','required'=>'true', 'enctype'=>'multipart/form-data']) }}
                    ...
                    <div class="form-group row {{ $errors->has('password') ? 'has-error' : '' }}">
                      ...
                      <div class="form-group row {{ $errors->has('image') ? 'has-error' : '' }}">
                          ...
                          <div class="col-9">
                              ...
                              @if($user->image)
                                  <img src="{{asset("uploads/$user->image")}}" class="mt-5" width="200" alt="">
                              @endif
                          </div>
                      </div>
                    <div class="form-group row">
                      ...
                      <div class="col-3">
                          <div class="radio-inline">
                              <label class="radio">
                                  <input type="radio" @if($user->gender == 1) checked @endif value="1" name="gender">
                                  <span></span>Male</label>
                              <label class="radio">
                                  <input type="radio" @if($user->gender == 0) checked @endif value="0" name="gender">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-3">
                         <span class="switch switch-outline switch-icon switch-success">
                          <label><input type="checkbox" {{ ($user->is_parent) ?'checked':'' }} name="is_parent" value="1">
                            <span></span>
                          </label>
                        </span>
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-3">
                         <span class="switch switch-outline switch-icon switch-success">
                          <label><input type="checkbox" {{ ($user->is_employee) ?'checked':'' }} name="is_employee" value="1">
                            <span></span>
                          </label>
                        </span>
                      </div>
