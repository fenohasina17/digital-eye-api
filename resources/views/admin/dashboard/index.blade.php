                ...
                <div class="col-xl-4">
                    ...
                    <a href="#" class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">{{$parents}}</div>
                            <div class="font-weight-bold text-inverse-white font-size-sm">Total Parents</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Stats Widget 16-->
                ...
                <div class="col-xl-4">
                    ...
                    <a href="#" class="card card-custom bg-info bg-hover-state-info card-stretch card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <div class="font-weight-bold text-inverse-info font-size-sm">Total Students</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Stats Widget 17-->
                ...
                <div class="col-xl-4">
                    ...
                    <a href="#" class="card card-custom bg-dark bg-hover-state-dark card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-inverse-dark font-weight-bolder font-size-h5 mb-2 mt-5">{{$quizzes}}</div>
                            <div class="font-weight-bold text-inverse-dark font-size-sm">Total Quizzes</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Stats Widget 18-->
