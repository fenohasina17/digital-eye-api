...
<div class="container">
    <div class="row">
        <div class="col-md-3">
            <div class="card" style="width: 18rem;">
                <svg class="card-img-top" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <g>
                ...
                <div class="card-body">
                  <h5 class="card-title">Announcements title</h5>
                  <p class="card-text">Some quick example text to build on the Announcements title and make up the bulk of the card's content.</p>
