...
class SchoolController extends Controller
{
    ...
    {
	    $title = 'Questions';
	    return view('admin.schools.index',compact('title'));
    }
	...
	public function getClients(Request $request){
		...
		if($users){
			foreach($users as $r){
				$edit_url = route('schools.edit',$r->id);
    ...
    public function store(Request $request)
    {
	    ...
	    Session::flash('success_message', 'Great! School has been saved successfully!');
	    $user->save();
    ...
    {
	    $user = School::find($id);
	    return view('admin.schools.single', ['title' => 'School detail', 'user' => $user]);
    }

	public function clientDetail(Request $request)
	{
		$user = School::findOrFail($request->id);
		return view('admin.schools.detail', ['title' => 'School Detail', 'user' => $user]);
	}
    ...
    {
	    $user = School::find($id);
	    return view('admin.schools.edit', ['title' => 'Edit school details'])->withUser($user);
    }
    ...
    public function update(Request $request, $id)
    {
	    ...
	    Session::flash('success_message', 'Great! School successfully updated!');
	    return redirect()->back();
    }
    ...
    public function destroy($id)
    {
	    $user = School::find($id);
        $user->delete();
        Session::flash('success_message', 'School successfully deleted!');
