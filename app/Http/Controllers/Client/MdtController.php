...
class MdtController extends Controller
{
    ...
    {  
	    ...
	    $title = 'MDTS';
	    return view('client.mdts.index',compact('title'))->with('school',$school);
    }
    ...
    public function getClients(){
	    ...
	    return view('client.mdts.index',compact('title'));;
    ...
    // {
	//     $title = 'Add New Mdt';
	//     return view('client.mdts.create',compact('title'));
    // }
    ...
    // {
	//     $user = Mdt::find($id);
	//     return view('client.mdts.single', ['title' => 'Client detail', 'user' => $user]);
    // }
	...
	// 	return view('client.mdts.detail', ['title' => 'Client Detail', 'user' => $user]);
	// }
    ...
    // {
	//     $user = Mdt::find($id);
	//     return view('client.mdts.edit', ['title' => 'Edit client details'])->withUser($user);
    // }
